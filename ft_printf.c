...
/*   Updated: 2023/04/04 19:21:51 by nihamdan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_flag_list(char flag, va_list arg, int len)
{
	if (flag == 'c')
		...
		len += ft_unsigned_putnbr_base(va_arg(arg, int), "0123456789");
	else if (flag == 'x')
		len += ft_unsigned_putnbr_base(va_arg(arg, int), "0123456789abcdef");
	else if (flag == 'X')
		len += ft_unsigned_putnbr_base(va_arg(arg, int), "0123456789ABCDEF");
	else if (flag == '%')
		len += ft_putchar('%');
